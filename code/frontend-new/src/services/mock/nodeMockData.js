...
export function getMockNodeLatest(deviceID) {
  const row = mockNodeReadings.find((reading) => String(reading.deviceID).toUpperCase() === String(deviceID).toUpperCase());
